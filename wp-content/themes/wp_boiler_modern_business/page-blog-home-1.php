    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <hr>
          <p><i class="fa fa-time"></i> Posted on August 28, 2013 at 10:00 PM</p>
          <hr>
          ...
          <a class="btn btn-primary" href="blog-post.html">Read More <i class="fa fa fa-angle-right"></i></a>
          ...
          <p class="lead">by <a href="#">Start Bootstrap</a></p>
          <hr>
          <p><i class="fa fa-time"></i> Posted on August 28, 2013 at 10:45 PM</p>
          <hr>
          <a href="blog-post.html"><img src="http://placehold.it/900x300" class="img-responsive"></a>
          <hr>
